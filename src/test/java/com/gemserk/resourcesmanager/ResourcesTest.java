package com.gemserk.resourcesmanager;
...
public class ResourcesTest {
	...
	public void test2() {
		...
		resourceManager.registerLoader(Image.class, new ImageLoaderProvider(Arrays.asList("logo-gemserk-512x116.png")));
	...
	public void test4() {
		...
		imageLoaderProvider.registerResourceLoader("logo-gemserk-512x116.png-inverted", new ResourceLoader<Image>() {
			@Override
			public Image load() {
		...
		resourceManager.registerLoader(Image.class, imageLoaderProvider);
	...
	public void test5() {
		final ResourceManager resourceManager = new ResourceManager();
		resourceManager.registerLoader(Font.class, new FontLoaderProvider());
	...
	public void test3() {
		ResourceManager resourceManager = new ResourceManager();
		resourceManager.registerLoader(Image.class, new AwtImageProvider2());
	...
	public void testReloadResource() {
		...
		resourceManager.reload("arial,0,24", Font.class);
	...
	public void testResourcesNotCacheables() {
		...
		ResourceLoaderProvider<String, Animation> animationsProvider = new ResourceLoaderProvider<String, Animation>();
		
		animationsProvider.registerResourceLoader("blue-ball", new ResourceLoader<Animation>() {
			@Override
		...
		resourceManager.registerLoader(Animation.class, animationsProvider);
