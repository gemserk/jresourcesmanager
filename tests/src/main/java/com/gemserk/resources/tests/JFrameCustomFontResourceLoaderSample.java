...
public class JFrameCustomFontResourceLoaderSample {
	...
	public static void main(String[] args) {
		...
		resourceManager.add("ZombieRockers", new ReloadableResourceLoaderImpl<Font>(new TrueTypeFontLoader(new FileSystemDataSource("assets/fonts/Mugnuts.ttf")), true));
		Resource<Font> fontResource = resourceManager.get("ZombieRockers");
		resourceManager.add("ZombieRockersPlain48px", new ReloadableResourceLoaderImpl<Font>(new DerivedFontLoader(fontResource, 48, Font.PLAIN)));
